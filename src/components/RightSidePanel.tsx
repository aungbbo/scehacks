...
export default function RightSidePanel() {
  return (
    <div className="fixed top-4 right-4 z-50 flex flex-col gap-4">
      ...
      <div className="w-80 h-96 bg-white border border-gray-200 rounded-xl shadow-lg flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 p-4 bg-gray-50">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200 max-w-[200px]">
                <p className="text-sm text-gray-800">Hi! I'm here to help you with anything you need. Ask me a question or let me help you organize your tasks!</p>
              </div>
            </div>
          </div>
        </div>
